...
import { createMainMenu, addGizmoBehavior, addColorBehavior, addHorizontalBehavior, create3DPanels } from "../js/interactions";
import { AbstractMesh } from "babylonjs";

export const createOpenScene = async function(engine: BABYLON.Engine, canvas: HTMLCanvasElement)
{
	return new Promise((resolve, reject) =>
	{
		...
		assetsManager.onFinish = function (tasks)
		{
			...
			//movement of sphere
			const sphere = getMesh(scene, "sphere", 1, true) as AbstractMesh;
